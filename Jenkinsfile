        ...
        stage('Deploying-services'){
            ...
            steps{
                sh '''
                    ...
                    ls
                    diff swagger.yaml swaggerv2.yaml --unified=0 || true
                '''
                }   
}
                ...
                expression { params.action == 'deployment' }
                        ...
                        steps{
                            ...
                            if( "${USER_INPUT}" == "Approve"){
                                sh '''
                                gcloud api-gateway api-configs create generic-updated-v2 --api=hello-world-api  --openapi-spec=swaggerv2.yaml
