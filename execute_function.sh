...
gcloud api-gateway api-configs describe generic-v2 --api=hello-world-api --view=FULL | yq '.openapiDocuments[0].document.contents' | base64 --decode > swagger-v2.yaml
cat swagger-v2.yaml
cp swagger-v2.yaml swaggerUpdatedv2.yaml
sed 's/function-1/'"$1"'/' swaggerUpdatedv2.yaml > swaggerUpdatedv2.yaml